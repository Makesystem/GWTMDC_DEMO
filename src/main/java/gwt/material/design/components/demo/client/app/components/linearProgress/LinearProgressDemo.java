package gwt.material.design.components.demo.client.app.components.linearProgress;
...
import gwt.material.design.components.client.ui.MaterialLinearProgress;
import gwt.material.design.components.demo.client.app.base.DemoPanel;

public class LinearProgressDemo extends Composite implements DemoPanel<MaterialLinearProgress> {

	private static ColorChooserUiBinder uiBinder = GWT.create(ColorChooserUiBinder.class);

	interface ColorChooserUiBinder extends UiBinder<Widget, LinearProgressDemo> {
	}

	@UiField
	MaterialLinearProgress to_do_tests_element;	

	public LinearProgressDemo() {
	...
	@Override
	public Set<MaterialLinearProgress> getWidgetForTests() {
