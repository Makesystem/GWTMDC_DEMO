...
public class ColorPaletteColumn extends Composite {

	private static HomeViewUiBinder uiBinder = GWT.create(HomeViewUiBinder.class);

	interface HomeViewUiBinder extends UiBinder<Widget, ColorPaletteColumn> {
	}
	...
	protected static native void download(String fileName, String text) /*-{
